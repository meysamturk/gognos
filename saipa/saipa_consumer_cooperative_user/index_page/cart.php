...
if(isset($_POST['update_update_btn'])){
   ...
   $update_quantity_query = mysqli_query($conn, "UPDATE $test_str SET quantity = '$update_value' WHERE id = '$update_id'");
...
if(isset($_GET['remove'])){
   ...
   mysqli_query($conn, "DELETE FROM $test_str WHERE id = '$remove_id'");
   header('location:cart.php');
};
...
if(isset($_GET['delete_all'])){
   $test = array($_SESSION['user_name']);
   $test_str=implode($test);
   mysqli_query($conn, "DELETE FROM $test_str");
   header('location:cart.php');
}
   ...
   <table class="table_cart" >
      ...
      <tbody>
         ...
         <tr>
            ...
            <td>
               <form action="" method="post">
                  ...
                  <input id="div1" type="number" name="update_quantity" min="0"  value="<?php echo $fetch_cart['quantity']; ?>" >
         ...
         <tr class="table-bottom">
            <td><a id="div1" href="products.php" class="option-btn" style="margin-top: 0;">ادامه خرید</a></td>
