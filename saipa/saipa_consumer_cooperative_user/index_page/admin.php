...
<section class="edit-form-container">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input id="div1" type="hidden" name="update_p_id" value="<?php echo $fetch_edit['id']; ?>">
      <input id="div1" type="text" class="box" required name="update_p_name" value="<?php echo $fetch_edit['name']; ?>">
      <input id="div1" type="number" min="0" class="box" required name="update_p_price" value="<?php echo $fetch_edit['price']; ?>">
      <input id="div1" type="submit" value="ویرایش" name="update_product" class="btn">
      <input id="div1" type="reset" value="خروج" id="close-edit" class="option-btn">
   </form>
