                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            ...
                            <p>
                                    <?php 
                                    $dash_category_query = "SELECT * from `login_users` ";
                                    $dash_category_query_run= mysqli_query($conn,$dash_category_query);
                                    $category_total = mysqli_num_rows( $dash_category_query_run); 
                                            echo  '
                                            <a href="add_user_create.php" type="button" class="btn btn-primary">
...
?>
                    ...
                    <div class="card-body">
                        <div class='row'>
                            ...
                            <p class="fw-bolder fs-2 text-primary-emphasis p-1 mb-4 bg-dark text-white text-center">تعاونی سایپا</p>
                                     <?php 
                                     if(isset($_GET['name'])&& $_GET['name']!='')
                                     { 
                                        $students = ($_GET['name']);
                                        
                                        $query = "SELECT * FROM `login_users` WHERE name='$students' ORDER BY id DESC ";
                                     ...
                                     elseif (isset($_GET['search']))
                                     {
                                        $test =array ('name');
                                         ...
                                         $query = "SELECT * FROM `login_users`   WHERE CONCAT(name,user_name) LIKE '%$filtervalues%'  ";
                                         $query_run = mysqli_query($conn, $query);
                                     }
                                     else {
                                        $test =array ('name');
                                        
                                        $query = "SELECT * FROM `login_users` ORDER BY id DESC ";
                                        $query_run = mysqli_query($conn, $query);
                                     }
                                        ...
                                        foreach($query_run as $student)
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="add_user_edit.php?id=<?= $student['id']; ?>" class="btn btn-success btn-sm">اصلاح</a>
                                                    </form>
