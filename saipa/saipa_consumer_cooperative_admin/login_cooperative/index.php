...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="./img/Gognos_icon.png" />
    ...
    <!-------------------- ------ Right Box ---------------------------->
       ...
       <div class="col-md-6 right-box">
          <div class="row align-items-center" >
            ...
            <?php } ?>
                <div class="header-text mb-4" dir="rtl" id="div1">
                     <h2>ققنس</h2>
                     <p>پنل پرسنل</p>
                </div>
                ...
                <div class="input-group mb-3 " type="submit">
                    <button class="btn btn-lg btn-primary w-100 fs-6 " >ورود</button>
                </div>
